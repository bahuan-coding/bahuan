...
const careerData: CareerEntry[] = [
  ...
  },
  {
    ...
    strategies: ["DV01 Sensitivity", "Calendar Spread", "DI Spread Trading", "Basis Trading"],
  ...
  },
  {
    ...
    isCurrent: false,
    icon: <Zap className="size-4" />,
    strategies: ["Market Making", "Odd Lot Arbitrage", "Penny Jumping", "Latency Arbitrage", "Box Spread", "ADR Arbitrage", "Delta Hedging", "Gamma Scalping", "Volatility Arbitrage"],
    techStack: ["C++", "Prolog", "Colocation (B3 Equinix SP4)", "FPGA Feed Handlers", "Kernel Bypass", "Lock-free Data Structures", "UDP Multicast"],
  },
  {
    id: "dlm-invista",
    company: "DLM Invista",
