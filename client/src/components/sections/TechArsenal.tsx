...
const categories: CategoryCard[] = [
  ...
  },
  {
    ...
    type: "tech",
    items: [
      { name: "AWS (ECS/Lambda/Cognito)", badge: "CLOUD_NATIVE" },
      { name: "Vercel Serverless", badge: "EDGE" },
      { name: "Netlify", badge: "JAM_STACK" },
      { name: "Docker / Compose", badge: "CONTAINERIZATION" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Multi-Persona AI Agents", badge: "ARCHITECTURE" },
      { name: "Compliance Detection (KYC/AML)", badge: "REAL_TIME" },
      { name: "SHAP Explainability", badge: "ML_OPS" },
      { name: "Agentic / Vibe Coding", badge: "PIONEER" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "PIX / Boleto / Cards", badge: "PAYMENTS" },
      { name: "NFS-e / NF-e (SERPRO)", badge: "FISCAL" },
      { name: "Circle API / USDC", badge: "BLOCKCHAIN" },
      { name: "B3 DMA Gateway", badge: "EXCHANGE" },
      { name: "BACEN / CVM APIs", badge: "REGULATORY" },
      { name: "WhatsApp Cloud API", badge: "CHANNELS" },
    ] as TechItem[],
  },
  {
    ...
    type: "tech",
    items: [
      { name: "PostgreSQL (Neon/Supabase)", badge: "PRIMARY" },
      { name: "Drizzle ORM / Prisma", badge: "TYPE_SAFE" },
      { name: "Redis (Vercel KV)", badge: "CACHE" },
      { name: "asyncpg / psycopg3", badge: "ASYNC" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Sentry / Datadog / Grafana", badge: "MONITORING" },
      { name: "PCI-DSS Compliance", badge: "SECURITY" },
      { name: "Semantic Release", badge: "VERSIONING" },
      { name: "Vercel Crons / Workers", badge: "SCHEDULING" },
      { name: "Playwright / Vitest", badge: "TESTING" },
    ] as TechItem[],
  },
];
