...
const projects: Project[] = [
  ...
  { name: "AI Agent Orchestration Platform", category: "AI_ML", description: "Multi-agent system with 30 profession-specific AI Product Managers and 8 parallel credit analysis agents. Pain point to product mapping, Gemini-powered pricing, shared context orchestration via asyncio.gather(). WhatsApp-first conversational interface.", tags: ["Python", "FastAPI", "Google Gemini", "OpenAI GPT-4", "Redis", "PostgreSQL"] },
  ...
  { name: "Quant Backtester & Strategy Discovery Engine", category: "DATA", description: "Institutional-grade backtesting system with 17 Rust crates (28K LOC). Genetic algorithm strategy discovery (NSGA-II Pareto), SIMD-accelerated metrics (AVX-512 f64x8), zero-alloc hot path achieving 93x speedup. Walk-Forward Analysis, PBO/DSR anti-overfitting gates.", tags: ["Rust", "SIMD/AVX-512", "Rayon", "Tauri", "React", "PostgreSQL"] },
  { name: "Strategy Combiner (SCG)", category: "AI_ML", description: "Generative Combiner System using genetic algorithms for autonomous strategy discovery. Multi-objective fitness (CAGR, Sharpe, MaxDD), Stage A/B validation pipeline, Hall of Fame promotion, OBFS binary storage (Parquet+Zstd+LMDB, 7.1x compression).", tags: ["Rust", "Genetic Algorithms", "NSGA-II", "Parquet", "LMDB", "Zstd"] },
  { name: "Quant Dashboard (Tauri Desktop)", category: "FRONTEND", description: "17-page terminal-style desktop app for strategy visualization. Evolution monitor, Pareto Frontier 3D, backtest drilldown, Hall of Fame, Miner Control (OMP 24/7), risk analytics (VaR/CVaR), Monte Carlo simulation.", tags: ["Tauri 2", "React 18", "Zustand", "Recharts", "TypeScript", "Rust"] },
  { name: "Market Data Hub (B3/US/FX)", category: "DATA", description: "Multi-market data ingestion for B3 (Brazil), US equities, and FX rates. Trading calendar generation, survivorship-bias-free universe, interest rate curves (SELIC/CDI), data integrity auditing with XXH3+BLAKE3.", tags: ["Rust", "CSV", "Memory-Mapped I/O", "B3", "Yahoo Finance", "BACEN"] },
];
